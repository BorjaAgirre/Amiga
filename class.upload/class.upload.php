...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        if (!$file) {
            $this->uploaded = false;
            $this->error = ' No hay archivo (linea 2649)';
//          $this->error = $this->translate('file_error') + ' No hay archivo (linea 2649)';
        }
        ...
        if (!is_array($file)) {
            if (empty($file)) {
                $this->uploaded = false;
//		$this->error = $this->translate('file_error') + ' Archivo vacío (linea 2656)';
                $this->error = ' Archivo vacio (linea 2656)';
            } else {
