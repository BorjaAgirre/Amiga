...
<!-- FORMULARIO INSERTAR PERSONA -->
	...
	<form name="persona" id="persona" enctype='multipart/form-data' action="insertar_persona.php" method="post">
...
<?php
		...
		imprimeItem("lugar_nac", "Ciudad Nacimiento", 12, "AAAAFF", 1, 80, false); 
			$sexo[0]=array ("titulo"=>"Mujer", "top"=>"12", "left"=>"01");
			$sexo[1]=array ("titulo"=>"Hombre", "top"=>"16", "left"=>"01");
		imprimeRadio($sexo, "sexo", "");

		imprimeItem("dni_pas", "DNI/Pasaporte/NIE", 12, "BBBBBB", 12, 20, false); 		
...
//		imprimeHistorial("telefono", "Teléfono", 12, "BBBBBB", 11, 68, false);     
		imprimeListaDesplegable("estado_civil", "Estado civil", "estado_civil", "fafd00", "est_civil", 150, 12, 80, false);	

		imprimeListaDesplegable("nucleo_conv", "Núcleo Convivencia", "despl_nucleoconv", "fafd00", "id_nucleo", 150, 24, 1, false);	
		imprimeItem("direccion", "Dirección vivienda actual", 30, "BBBBBB", 24, 23, false);     
//		imprimeHistorial("direccion", "Dirección vivienda actual", 30, "BBBBBB", 23, 44, false); 
		...
		imprimeItem("Empadronamiento", "Domicilio padrón actual", 30, "BBBBBB", 36, 23, false);     
		imprimeListaDesplegable("poblacion_padron", "Población padrón actual", "poblaciones", "fafd00", "id_poblacion", 250, 36,60, false); 

		imprimeItem("n_hijos", "Nº hijos/as", 1, "ffbf5a", 50, 15, false);     
		imprimeCheckbox("hijos", "¿Hijos/as?", "ffbf5a", 50, 1, "arriba", false);
		imprimeTexto("observaciones_hijos", "Observaciones Familia", 4,30, "BBBBBB", 50, 30, false);    
		imprimeTexto("telefonos_interes", "Teléfonos de interés", 6,30, "BBBBBB", 50, 65, false);      
...
//   #################################################
	...
	echo "<div id='formativo' style='display:;'>";
		...
		imprimeListaDesplegable("DatosFormativosItem", "Nivel formativo", "despl_estudios", "fafd00", "nivelFormativo", 240, 1,1, false);
		...
		imprimeTexto("DatosFormativosObs", "Datos de formación y trabajo", 3,40, "AAFFAA", 1, 33, false);     
		imprimeTexto("Idioma", "Idiomas", 3,35, "ffbf5a", 18, 33, false);    
		imprimeTexto("cursos", "Cursos", 3,50, "ffbf5a", 55, 35, false);

		imprimeTitulo("TituloIngresos", "Ingresos", 50, 5, true);		

		imprimeItem("num_ss", "Nº S. Social", 15, "BBBBBB", 18, 70, false);     
		...
		imprimeCheckbox("IngresosRentaBas", "Renta Garantía de Ingresos", "DDDDDD" , 70, 5, "dcha", false);
		...
		imprimeCheckbox("exp_laboral", "Experiencia Laboral", "DDDDDD" , 43, 1, "dcha", false);
		imprimeCheckbox("lanbide", "Lanbide", "DDDDDD" , 40, 35, "izda", false);
		imprimeCheckbox("inem", "INEM", "DDDDDD" , 48, 37, "izda", false);
		
		
		imprimeItemFecha("F_alta_lanbide", "Fecha alta", 12, "BBBBBB", 36, 48, false);     
		imprimeItemFecha("F_renov_lanbide", "Fecha renovac.", 12, "BBBBBB", 36, 73, false);     
		imprimeItemFecha("F_alta_inem", "Fecha alta", 12, "BBBBBB", 46, 48, false);     
		imprimeItemFecha("F_renov_inem", "Fecha renovac.", 12, "BBBBBB", 46, 73, false);     
...
//  Está por poner los nombres de base de datos correspondientes
		...
		imprimeItemFecha("fressol", "fecha:", 8, "", 24, 46, true);  
		imprimeItem("nresconc", "Nº", 6, "", 28, 65, true);  
		imprimeItemFecha("fresconc", "fecha:", 8, "", 28, 46, true);  
		...
		imprimeItem("nrestrconc", "Nº", 6, "", 42, 65, true);  
		imprimeItemFecha("frestrconc", "fecha:", 8, "", 42, 46, true);  
		...
		imprimeItemFecha("fentrada", "Fecha de entrada en España: ", 10, "", 54, 50, true);  
		imprimeItemFecha("fprueba", "Fecha de primera prueba: ", 10, "", 58, 50, true);  
...
<?php
		...
		imprimeListaDesplegable("tutor", "Tutor", "tutor", "fafd00", "nombre", 120, 5, 1, true);
...
*/
		...
		imprimeCheckbox("lista_espera_piso", "Lista espera piso", "", 5, 40, "dcha", true);

		imprimeListaDesplegable("procedencia_demanda_lista", "Demanda", "despl_demanda", "fafd00", "id_deman", 240, 10, 1, true);
		imprimeItem("procedencia_demanda", "Concreción", 25, "AAFFAA", 10, 40, true);
		...
		echo "<br><p>Prueba con los pisos <a href='include/pisos/prueba_drag_drop.php'>aquí</a></p>";

		imprimeItem("num_expediente", "Número de expediente", 8, "", 15, 1, true);     
...
//		imprimeCheckbox("orient_laboral", "Orientación laboral", "", 80, 60, "dcha", false);
		...
		imprimeCheckbox("come_lu", "lunes", "", 9, 85, "dcha", false);
		imprimeCheckbox("come_ma", "martes", "", 13, 85, "dcha", false);
		imprimeCheckbox("come_mi", "miércoles", "", 17, 85, "dcha", false);
		imprimeCheckbox("come_ju", "jueves", "", 21, 85, "dcha", false);
		imprimeCheckbox("come_vi", "viernes", "", 25, 85, "dcha", false);

		imprimeTitulo("tiempo_libre", "Tiempo libre", 30, 85, true);
		imprimeCheckbox("tl_sabado", "Sábado", "", 34, 85, "dcha", false);
		imprimeCheckbox("tl_domingo", "Domingo", "", 38, 85, "dcha", false);
		...
		imprimeCheckbox("medicacion_centro", "Medicación en centro", "", 65, 85, "dcha", false);

		imprimeTitulo("salidas", "Salidas", 74, 85, true);
		imprimeCheckbox("salida_verano", "Verano", "", 78, 85, "dcha", false);
		imprimeCheckbox("salida_otro", "Otra salida (Arantzazu...)", "", 82, 85, "dcha", false);
